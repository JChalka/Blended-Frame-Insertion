...
def write_rgbw_header(
    ...
    lines = [
        ...
        "",
        f"static const uint16_t RGBW_LUT_R[{entry_count}] = {{",
        format_header_u16_entries(flattened[:, 0]),
        "};",
        "",
        f"static const uint16_t RGBW_LUT_G[{entry_count}] = {{",
        format_header_u16_entries(flattened[:, 1]),
        "};",
        "",
        f"static const uint16_t RGBW_LUT_B[{entry_count}] = {{",
        format_header_u16_entries(flattened[:, 2]),
        "};",
        "",
        f"static const uint16_t RGBW_LUT_W[{entry_count}] = {{",
